...
public class Queen implements Piece{
    ...
    public boolean isValidMove(Cell sourceCell, Cell targetCell, Board board) {
        ...
        // Check if move is either straight (rook-like) or diagonal (bishop-like)
        boolean isStraightMove = sourceRow == targetRow || sourceCol == targetCol;
        boolean isDiagonalMove = abs(sourceRow - targetRow) == abs(sourceCol - targetCol);
        ...
        // Traverse the path towards the target cell
